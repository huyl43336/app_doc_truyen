...
public class databasedoctruyen extends SQLiteOpenHelper {
    ...
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'huy','huy','huy@gmail.com',1)";
    ...
    private String SQLQuery9 = "INSERT INTO truyen VALUES (null,'Sự tích bông hoa cúc trắng','Ngày xưa, có hai mẹ con nhà nọ sống trong một túp lều nơi xóm vắng. Người chồng mất sớm, nên mẹ con làm lụng vất vả lắm mới đủ ăn. Hằng ngày, gà chưa gáy sáng, bà mẹ đã phải dậy làm việc cho đến mãi tận đêm khuya.\n" +
            "\n" +
            "\n" +
            ...
            "\n"+
            "Ý nghĩa câu chuyện: Qua câu chuyện này, ta thấy không phải nhờ bông hoa thần mà chính tấm lòng hiếu thảo của người con đã tạo ra kì tích cứu sống mẹ của em. Nếu không có sự hiếu thảo thì đã không thể cảm động trời xanh và được Đức Phật ra tay cứu giúp.','https://anh.eva.vn/upload/4-2017/images/2017-12-20/maxresdefault-1513743970-217-width640height480.jpg',1)";
    private String SQLQuery10="INSERT INTO truyen VALUES (null,'Cậu bé chăn cừu và cây đa cổ thụ','Ngày xửa ngày xưa, xưa lắm rồi khi mà muôn thú, cây cỏ, con người còn trò chuyện được với nhau. Trên đồng cỏ rậm ven khu làng có một loài cây gọi là cây đa. Đó là một thứ cây to, khỏe, lá của nó rậm rạp đến nỗi không một tia nắng nào có thể lọt qua được. Vào những ngày trời nắng nóng người ta thường nghỉ chân một lát và trò chuyện hàn huyên cùng cây dưới bóng cây mát rượi. Mọi người ai cũng biết rằng cây đa rất thông thái vì cây đã có tuổi, đã từng trải.\n"+
            "\n"+
            "Ý nghĩa câu chuyện: Qua câu chuyện này, ta thấy không phải nhờ bông hoa thần mà chính tấm lòng hiếu thảo của người con đã tạo ra kì tích cứu sống mẹ của em. Nếu không có sự hiếu thảo thì đã không thể cảm động trời xanh và được Đức Phật ra tay cứu giúp.','https://cotich.net/uploads/images/truyen-thuyet-thanh-giong-5.jpg',2)";
    ...
    public void onCreate(SQLiteDatabase db) {
        //thuc thi cau truy van k tra ve ket qua
        db.execSQL(SQLQuery);
    ...
    // lay 4 truyen moi nhat
    public Cursor getData1(){
        SQLiteDatabase db = this.getReadableDatabase();

        Cursor res = db.rawQuery("SELECT * FROM "+TABLE_TRUYEN+" ORDER BY "+ID_TRUYEN+" DESC LIMIT 8",null);
        return res;
    }
